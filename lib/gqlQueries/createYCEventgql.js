...
export const INSERT_EVENT_SEATING = gql`
  mutation insertEventSeating($eventId: uuid) {
    insert_yc_event_seating(objects: {event_id: $eventId}) {
      affected_rows
    }
  }
`

// this is part of the refactor new version of query
export const UPDATE_EVENT = gql`
mutation updateYcEvent($eventId: uuid, $object: yc_events_set_input!) {
  update_yc_events(where: {_and: {id: {_eq: $eventId}}}, _set: $object) {
    affected_rows
  }
}`;
