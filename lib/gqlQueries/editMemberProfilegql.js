...
export const UPDATE_YC_MEMBER_AS_RACER = gql`
  mutation updateMemberAsRacer($memberId: uuid, $isRacer: Boolean) {
  update_yc_members(where: {id: {_eq: $memberId}}, _set: {isRacer: $isRacer}) {
    returning {
      isRacer
    }
  }
