...
const useReservationsFacade = () => {
  ...
  const ticketArray = data.yc_event_purchased_tickets.sort((a, b) => a.yc_member.name.localeCompare(b.yc_member.name));
  let facade = ticketArray.map(reservation => {
    return {
      id: reservation.id,
